            ...
            <div class="container py-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <a class="btn border-secondary rounded-pill py-3 px-5" href="index.html">Ana Sayfaya Git</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">KALİTENİN MERKEZİ</p>
                            </a>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a class="btn-link" href="">Gizlilik Poltikası</a>
                            <a class="btn-link" href="">Şartlar ve koşullar</a>
                            <a class="btn-link" href="">İade politikasi</a>
