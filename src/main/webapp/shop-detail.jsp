    ...
    <body>
       ...
       <jsp:include page="header.jsp"/>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Alışveriş Detayları</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">Ana Sayfa</a></li>
                <li class="breadcrumb-item"><a href="#">Sayfalar</a></li>
                <li class="breadcrumb-item active text-white">Alışveriş Detayları</li>
            </ol>
        </div>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="mb-3">Kategori: Sebze</p>
                                <h5 class="fw-bold mb-3">30 ₺</h5>
                                ...
                                <nav>
                                    <div class="nav nav-tabs mb-3">
                                        <button class="nav-link active border-white border-bottom-0" type="button" role="tab"
                                            ...
                                            aria-controls="nav-about" aria-selected="true">Açıklama</button>
                                        <button class="nav-link border-white border-bottom-0" type="button" role="tab"
                                            id="nav-mission-tab" data-bs-toggle="tab" data-bs-target="#nav-mission"
                                            aria-controls="nav-mission" aria-selected="false">İncelemeler</button>
                                    </div>
                                </nav>
                                <div class="tab-content mb-5">
                                            ...
                                            <div class="row g-4">
                                                <div class="col-6">
                                                    ...
                                                    <div class="row text-center align-items-center justify-content-center py-2">
                                                        <div class="col-6">
                                                            <p class="mb-0">Menşei</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="mb-0">Çiftlikten</p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p class="mb-2" style="font-size: 14px;">12 Mart 2024</p>
                            ...
                            <form action="#">
                                <h4 class="mb-5 fw-bold">İnceleme Bırakın</h4>
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-between py-3 mb-5">
                                            <div class="d-flex align-items-center">
                                                <p class="mb-0 me-3">Lütfen Puanlayın:</p>
                                            ...
                                            <a href="#" class="btn border border-secondary text-primary rounded-pill px-4 py-3"> Yorum</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
