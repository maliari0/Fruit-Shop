    ...
    <body>
       ...
       <jsp:include page="header.jsp"/>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">İletişim</h1>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                <h1 class="text-primary">Bize Ulaşın</h1>
                                <p class="mb-4">Lorem ipsum<a href="https://htmlcodex.com/contact-form">Temp</a>.</p>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-7">
                            <form action="" class="">
                                ...
                                <button class="w-100 btn form-control border-secondary py-3 bg-white text-primary " type="submit">Gönder</button>
                            </form>
                        </div>
                        <div class="col-lg-5">
